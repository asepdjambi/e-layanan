...
<head>
          ...
          <link href="{{ asset('admin/assets/img/dishub.png')}}" rel="apple-touch-icon">
          ...
          <link href="{{ asset('admin/assets/vendor/venobox/venobox.css')}}" rel="stylesheet">
          <link href="{{ asset('admin/assets/vendor/remixicon/remixicon.css')}}" rel="stylesheet">
          <link href="{{ asset('admin/assets/vendor/aos/aos.css')}}" rel="stylesheet">

          <!-- Template Main CSS File -->
          <link href="{{ asset('admin/assets/css/style_gp.css')}}" rel="stylesheet">
...
<body>
         ...
         <header id="header" class="fixed-top ">
                   <div class="container d-flex align-items-center justify-content-between">
                             ...
                             <h1 class="logo"><a href="#">E-LAYANAN DINAS PERHUBUNGAN</a></h1>
                             ...
                             <nav class="nav-menu d-none d-lg-block">
                                       <ul>
                                                 ...
                                                 <li class="drop-down"><a href="">Layanan</a>
                                                           <ul>
                                                                     <li><a href="/bussimpandepan">Peminjaman Bus</a></li>
                                                                     <li class="drop-down"><a href="#">Deep Drop
                                                                                         Down</a>
                                                                               <ul>
...
@yield('content')
         ...
         @yield('footer') <!-- ======= Footer ======= -->
          ...
          <script src="{{ asset('admin/assets/vendor/venobox/venobox.min.js')}}"></script>
          ...
          <script src="{{ asset('admin/assets/js/main_gp.js')}}"></script>
