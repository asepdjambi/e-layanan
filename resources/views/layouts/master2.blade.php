...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top">
            <div class="brand">
                <a href="index.html"><img src="{{asset('admin/assets/img/e-layanan-logo.png')}}" alt="Klorofil Logo"
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img
                                    src="{{asset('admin/assets/img/user_2.png')}}" class="img-circle" alt="Avatar">
                        ...
                        <li>
                            ...
                            <div id="subPages2" class="collapse ">
                                <ul class="nav">
                                    ...
                                    <li>
                                        <a href="#" class="">Penggunaan Jalan</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
    ...
    <script>
        <script src="{{asset('admin/assets/vendor/jquery/jquery.mask.js')}}">
    </script>
