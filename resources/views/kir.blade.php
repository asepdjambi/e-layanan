...
@section('content')
    ...
    <div class="panel">
        <div class="panel-heading">
            <h2>Data Permohonan Surat Rekomendasi KIR</h2>
            <div class="right">
                <a href="/kirsimpan" class="btn btn-primary floa">TAMBAH PEMOHON</a>
                    ...
                    @foreach ($datakir as $k)
                        <tr>
                            ...
                            class="lnr lnr-printer"> CETAK</i></a> --}}
                                <a href="/kir/{{ $k->id }}/tampilkir" class="btn btn-success btn-sm" target="_blank"><i class="lnr lnr-printer">
                                        CETAK</i></a>
                            </td>
                        </tr>
                    @endforeach
